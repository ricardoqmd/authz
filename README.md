...
| `@ricardoqmd/authz-react` | A React binding: a provider, hooks and a guard over a session. **No transport concept.** |

A Vue binding is planned; see [ROADMAP.md](./ROADMAP.md).
